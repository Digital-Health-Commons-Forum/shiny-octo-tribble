{
  ...
  "paths": {
    ...
    "/worker/ready": {
      "post": {
        "summary": "Worker ready notification",
        "description": "Notifies the webserver that a worker process is ready.",
        "operationId": "workerReady",
        "tags": [
          "Worker"
        ],
        "parameters": [
          {
            "in": "body",
            "name": "workerReady",
            "description": "Worker ready notification payload",
            "required": true,
            "schema": {
              "type": "object",
              "properties": {
                ...
                "version": {
                  "type": "string",
                  "description": "Version of the worker process (optional)"
                }
              }
            }
          }
        ...
        "responses": {
          "200": {
            "description": "Worker ready notification received"
          },
          "400": {
            "description": "Invalid input"
          },
